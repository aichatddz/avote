...
snarkjs zkey contribute ./compile/vote_0000.zkey ./vote_0001.zkey --name="1st Contributor Name" -v
...
snarkjs zkey contribute ./compile/decrypt_0000.zkey ./decrypt_0001.zkey --name="1st Contributor Name" -v
...
snarkjs zkey contribute ./compile/publickey_0000.zkey ./publickey_0001.zkey --name="1st Contributor Name" -v
